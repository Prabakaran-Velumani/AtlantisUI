...
// GameAssertLeaderBoard component
interface GameAssertLeaderBoardProps {
...
const LeaderBoardList : React.FC<GameAssertLeaderBoardProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getLeaderBoards  = async () =>{
    const list = await getGameAssets('leaderboard');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        { Header: 'Leader Board Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
