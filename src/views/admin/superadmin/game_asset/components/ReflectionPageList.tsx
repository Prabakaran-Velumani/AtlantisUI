...
// GameAssertReflection component
interface GameAssertReflectionProps {
...
const ReflectionPageList : React.FC<GameAssertReflectionProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getReflections  = async () =>{
    const list = await getGameAssets('reflection');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        ...
        { Header: 'Reflection Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
...
export default ReflectionPageList;