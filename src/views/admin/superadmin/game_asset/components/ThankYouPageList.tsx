...
// GameAssertThankYou component
interface GameAssertThankYouProps {
...
const ThankYouPageList : React.FC<GameAssertThankYouProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getThankYou  = async () =>{
    const list = await getGameAssets('thankyou');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        ...
        { Header: 'ThankYou Image Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
...
export default ThankYouPageList;