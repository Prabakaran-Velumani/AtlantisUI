...
// GameAssertBadge component
interface GameAssertBadgeProps {
...
const BadgeList : React.FC<GameAssertBadgeProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getBadges  = async () =>{
    const list = await getGameAssets('badge');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        ...
        { Header: 'Badge Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
