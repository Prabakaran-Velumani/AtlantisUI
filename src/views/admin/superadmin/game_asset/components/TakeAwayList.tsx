...
interface GameAssertTakeAwayProps {
...
const TakeAwayList : React.FC<GameAssertTakeAwayProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getTakeAway  = async () =>{
    ...
    const list = await getGameAssets('takeaway');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        ...
        { Header: 'Take Away Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
