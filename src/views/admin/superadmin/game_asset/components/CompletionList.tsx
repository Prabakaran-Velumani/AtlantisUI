...
// GameAssertCompletions component
interface GameAssertCompletionProps {
...
const CompletionList : React.FC<GameAssertCompletionProps> = ({handleEditRow, handleDeleteRow,reRender,isEditing,isFormEditMode}) =>{
...
const getCompletions  = async () =>{
    const list = await getGameAssets('completion');
...
// actionlist:[{name: "Add", function: 'createFunc'}, {name: "Edit", function: 'handleEdit(index)'}, {name: "Delete", function: 'deleteFunc'},{name: "Download", function: 'downloadFunc'}]
    const columns = [
        ...
        { Header: 'Completion Name', accessor: 'gasAssetName', type: 'text', actionlist:[]},
