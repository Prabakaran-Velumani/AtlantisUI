    ...
    : CompKeyCount + currentTab+1
                  ...
                  {currentTab === 1 && (
                    ...
                    {currentTab === 2 && (
                      ...
                      preview={false}
                      formData={formData}  imageSrc={ScreenMainImages[currentTab]} reflectionQuestions={reflectionQuestions} reflectionQuestionsdefault={reflectionQuestionsdefault}/>
                    )}
                    {currentTab === 3 && (
                      <TakeAwaysContentScreen 
                      preview={false}
                      formData={formData} imageSrc={ScreenMainImages[currentTab]}/>
                    )}
                    {currentTab === 4 && (
