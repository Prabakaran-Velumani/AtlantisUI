...
{compliData[CompKeyCount]?.gameIsSetCongratsScoreWiseMessage === 'false' && compliData[CompKeyCount]?.gameIsSetDistinctionScore === 'false' && compliData[CompKeyCount]?.gameIsSetMinPassScore === 'false' ? (
