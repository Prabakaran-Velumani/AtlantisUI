    ...
    <>
      ...
      */
      ...
      fontSize={{
        ...
        md: '15px',
        lg: '20px',
      }} style={{textAlign:'center',color:'white'}}>Preview Is Not Available ("The welcome screen preview will appear once you complete the story and head to the design section to create the welcome screen".) </Text></Box>:  (
        <Box className="welcome-screen">
          <Box className="welcome-screen-box">
            <Img src={imageSrc} className="welcome-pad" />
          </Box>
