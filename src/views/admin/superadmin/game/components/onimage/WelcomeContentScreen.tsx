      ...
      {imageSrc && preview ? (
        ...
        <Box className="welcome-screen">
          ...
          >
            ...
            >
              ...
              >
                <>
                <span style={customStylesicon}><Icon as={FaClock} /> {(formData.gameDuration > 1) ? " "+formData.gameDuration + " mins" : "Few mins"}</span>
            ...
            { formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true' ? (
                <Img src={Skills} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ) : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill !== 'true' ? (
                <Img src={LearningOutcome} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ): formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill === 'true' ? (
                <Img src={SkillsLearningOutcome} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ): ''}
              <Box display={'flex'}  className={ formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true' ? 'rewards-box' : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill !== 'true' ? 'rewards-box' : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill === 'true' ? 'rewards-box': 'empty-rewards-box'}>
                {(formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true') ? (
                  <>
                   <Box className='box-1'>
                      <Box
              ...
              {formData.gameIsShowStoryline === 'true' ? (
                <Img src={Story} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ) : ''}
              {formData.gameIsShowStoryline == 'true' && (
                <Text
                  mt={'20px'}
              ...
              {formData.gameIsShowAdditionalWelcomeNote === 'true' ? (
                <Img src={Note} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ) : ''}
              {formData.gameIsShowAdditionalWelcomeNote === 'true' && (
                <Box
                  w={'100%'}
              ...
              {formData.gameIsShowAuhorName === 'true' ? (
                <Img src={Author} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ) : ''}
              {formData.gameIsShowAuhorName === 'true' && (
                <Box
                  w={'100%'}
        ...
        <Box className="welcome-screen">
          ...
          <Box className="content-box" fontFamily={'gametext'}>
            ...
            <Box w={'60%'} className="content" style={{marginTop: '25px'}}>
            { formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true' ? (
                <Img src={Skills} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ) : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill !== 'true' ? (
                <Img src={LearningOutcome} mt={'25px'} alt="rew" w={'100%'} h={'20px'} />
              ...
              <Box
                display={'flex'}
                className={ formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true' ? 'rewards-box' : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill !== 'true' ? 'rewards-box' : formData.gameIsShowLearningOutcome === 'true' && formData.gameIsShowSkill === 'true' ? 'rewards-box': 'empty-rewards-box'}
              >
                {(formData.gameIsShowSkill === 'true' && formData.gameIsShowLearningOutcome !== 'true') ? (
                  <>
                    <Box className="box-1">                      
