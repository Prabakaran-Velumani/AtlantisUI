              ...
              >
                ...
                {(formData.gameIsCollectLearnerFeedback === 'true' ||
                  ...
                  <>
                    ...
                    >
                      {/* <SimpleGrid column={2} > */}
                      {/* {(formData.gameContent === 'true' || preview) && ( */}
                      <Box display={'flex'} ml={'5px'}>
                        ...
                        {/* )} */}
                        {/* {(formData.gameRelevance === 'true' || preview) && ( */}
                        <div className="content-box">
                          <Text
                            fontSize={18}
                            fontWeight="300"
                      ...
                      {/* )} */}
                      {/* {(formData.gameBehaviour === 'true' || preview) && ( */}
                      ...
                      {/* )} */}
                      {/* {(formData.gameGamification === 'true' || preview) && ( */}
                      <Box display={'flex'} mt={'5px'} ml={'5px'}>
                        <div className="content-box">
                          <Text
                            fontSize={18}
                        ...
                        {/* {(formData.gameOthers === 'true' || preview) && ( */}
                        <div className="content-box">
                          <Text
                            fontSize={16}
                            fontWeight="300"
                      ...
                      {/* )} */}
                      {/* {(formData.gameFeedBack === 'true' || preview) && ( */}
                      <Box display={'flex'} mt={'5px'} ml={'5px'}>
