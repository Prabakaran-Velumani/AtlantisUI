...
const ReflectionScreen: React.FC<{
  ...
  const [characterCount, setCharacterCount] = useState<number[]>(
    ...
    Array.from({ length: showTextArea }, (_, index) =>
      reflectionQuestions[`ref${index + 1}`]?.length
        ? 90 - reflectionQuestions[`ref${index + 1}`]?.length
        : 90,
    ),
  );
  ...
  const handleArra = (e: any) => {
    ...
    setFormData((prev: any) => ({
      ...prev,
      gameReflectionQuestion: selectedValue,
    }));
    if (selectedValue === 1) {
      setShowTextarea('A');
    ...
    <Stack direction="column" gap="20px">
      <Card>
        ...
        >
          ...
          <Switch
            isChecked={
              formData.gameIsShowReflectionScreen === 'true' ? true : false
            }
            color="#fff"
          ...
          <>
            ...
            >
              ...
              <Select
                ...
                id="Collection"
                isDisabled={
                  formData?.gameIsShowReflectionScreen === 'true' ? false : true
                }
            ...
            {Array.from({ length: showTextArea }, (_, index) => (
              <div>
                <TextField
                  ...
                  onChange={(e: any) =>
                    handleTextReflectionChange(e, index + 1)
                  }
