...
const ChatButton: React.FC = () => {
  ...
  const [messages, setMessages] = useState<any[]>([ // Adjust the type based on your actual message structure
    {
  ...
  async function processMessageToChatGPT(chatMessages: any[]) { // Adjust the type based on your actual message structure
