...
const NoteCompo: React.FC<PropsNote> = ({ reviews, seq, index, name, handleInput, input, getSeq, duplicateSeq, delSeq, alphabet, setNavigation, handleBlock, handleSelectBlock, items, showSelectBlock, setSelectBlock, ShowReview }) => {
