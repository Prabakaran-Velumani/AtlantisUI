                  ...
                  >
                    ...
                    >
                      ...
                      <Input
                        ...
                        title={alp.option}
                        value={
                          input?.[`Interaction${seq.input}`]?.optionsObject?.[
                            alp.option
                          ]
                        }
                        w={'240px'}
                    ...
                    <Td p={0} alignItems={'center'}>
                      <Box>
                        <Input
                          ...
                          onChange={handleInput}
                          value={
                            input?.[`Interaction${seq.input}`]?.scoreObject?.[
                              alp.option
                            ]
                          }
                        />
          ...
          .map((alp: any, i: number) => (
            <Flex mb={'13px'}>
              ...
              <Box
                ...
                cursor={'pointer'}
                display={
                  input?.[`Interaction${seq.input}`]?.navigateshowObjects?.[
                    alp.option
                  ]
                    ? 'block'
                    : 'none'
              ...
              >
                ...
                !input?.[`Interaction${seq.input}`]?.navigateObjects?.[
                  alp.option
                ] ? (
                  <Select
                    placeholder={'Blocks...'}
