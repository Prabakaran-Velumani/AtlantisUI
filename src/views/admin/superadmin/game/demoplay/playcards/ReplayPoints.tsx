                    ...
                    <Box className="replay_content_center">
                      <Box className="title_replay">
                        <Text fontFamily={'AtlantisContent'} textAlign={'center'}>
                          {modelScreen === true ? "No previous block Do You want to redirect to Chapter Selection" : "You have been redirected to replay point. Click replay button to continue...!"}
                        </Text>
                      </Box>
                      <Box
                        w={'100%'}
