...
const Welcome: React.FC<{
  ...
  imageSrc: any;
  preview: any;
}> = ({ formData, imageSrc, preview, setCurrentScreenId}) => {
  const { id } = useParams();
  ...
  console.log('welcome screen',formData)
  return (
    <>
      {true && (
    ...
    >
      ...
      <Box w={'60%'} className="content">
        ...
        <Box
            ...
            alignItems={'center'}
          >
            <Img transform={'scale(1.3)'} src={next} onClick={()=>setCurrentScreenId(2)} cursor={'pointer'} />
          </Box>
      </Box>
    </Box>
  </Box>
