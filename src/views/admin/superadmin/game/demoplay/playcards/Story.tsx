...
const Story: React.FC<{
  ...
  resMsg:any;
  feed:any;
}> = ({ data, type, first, showNote, resMsg, feed,getData, option, options ,handleValidate}) => {
  console.log(data);
  return (
    <>
      <Flex height="100vh" zIndex={9999999999999999999999}>
        {data && type === 'Note' && (
          <Box 
            w={'100%'}
            h={'100vh'}
            ...
            >
              ...
              >
                ...
                <Box
                  ...
                  w={'100%'}
                >
                  <Box w={'60%'} fontSize={'18px'} letterSpacing={1} >{data?.blockText}</Box>
                </Box>
                <Box
                  mt={'10px'}
                  w={{ sm: '200px', md: '400px' }}
