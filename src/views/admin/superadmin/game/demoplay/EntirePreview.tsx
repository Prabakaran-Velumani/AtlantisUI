...
const EntirePreview: React.FC<{
  ...
  tab?: any;
  formData?: any;
}> = ({ prevdata, show, isOpen, onOpen, onClose, formData,tab }) => {
  ...
  const overOptions = [{value:1,label:'Bacground'},{value:2,label:'Non Playing Character'},{value:3,label:'Overview'},{value:4,label:'Story'},{value:5,label:'Design'}]
